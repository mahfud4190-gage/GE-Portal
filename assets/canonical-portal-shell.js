...
const ALIAS={
 'e1-inisiatif.html':'inisiatif.html','e1-calendar.html':'calendar.html','e1-standar.html':'standar.html',
 'e1-service-planning.html':'service-planning.html','e1-planning-documents.html':'planning-documents.html',
 'e1-data.html':'data.html','e1-admin.html':'admin.html','e1-berita.html':'berita.html','e1-kontak.html':'kontak.html',
 'e1-lounge-list.html':'lounge-list.html','e1-branch-office-planning.html':'branch-office-planning.html','e1-gaso-planning.html':'gaso-planning.html'
};
const canonicalPath=()=>ALIAS[path()]||path();
const route=(href)=>({
 'inisiatif.html':'e1-inisiatif.html','calendar.html':'e1-calendar.html','standar.html':'e1-standar.html',
 'service-planning.html':'e1-service-planning.html','planning-documents.html':'e1-planning-documents.html','data.html':'e1-data.html',
 'admin.html':'e1-admin.html','berita.html':'e1-berita.html','kontak.html':'e1-kontak.html','lounge-list.html':'e1-lounge-list.html',
 'branch-office-planning.html':'e1-branch-office-planning.html','gaso-planning.html':'e1-gaso-planning.html'
}[href]||href);
const item=(href,label,i,sub=false)=>`<a class="ge-nav-link ${sub?'ge-nav-sub':''} ${canonicalPath()===href?'active':''}" href="${route(href)}" title="${label}">${icon(i)}<span>${label}</span></a>`;
...
const finalUserPages=new Set(['index.html','e1-inisiatif.html','e1-calendar.html','e1-standar.html','e1-service-planning.html','e1-planning-documents.html','e1-data.html','e1-admin.html','e1-berita.html','e1-kontak.html','e1-lounge-list.html','e1-branch-office-planning.html','e1-gaso-planning.html','customer-experience.html','cx-import.html','touchpoint.html','network-stations.html','station-360.html','inisiatif.html','improvement-intake.html','action-scenario.html','calendar.html','budget-cost.html','program-kerja.html','cost-intelligence.html','readiness.html','agreement-service.html','standar.html','data.html','master-data.html','admin.html','portal-management.html','audit-log.html','service-capability.html','service-locations.html','berita.html','kontak.html','management-outcome.html','airport-experience-map.html','map.html','profile.html','service-planning.html','planning-workspace.html','lounge-list.html','branch-office-planning.html','gaso-planning.html','planning-documents.html']);
const PLANNING_PAGES=new Set(['service-planning.html','planning-workspace.html','lounge-list.html','branch-office-planning.html','gaso-planning.html','planning-documents.html','e1-service-planning.html','e1-lounge-list.html','e1-branch-office-planning.html','e1-gaso-planning.html','e1-planning-documents.html']);
const PLANNING_TABS=[
...
function planningTabs(){
 if(!PLANNING_PAGES.has(path())&&!PLANNING_PAGES.has(canonicalPath()))return;
 ...
 if(title&&canonicalPath()!=='planning-workspace.html')title.dataset.gePlanningTitle=title.textContent.trim();
}
function cleanNavigation(){
 ...
 side.querySelectorAll('.ge-nav-link[href]').forEach(a=>a.classList.toggle('active',canonicalPath()===(a.getAttribute('href')||'').split('?')[0].split('#')[0]));
}
...
function setupPeriodControl(){
 ...
 sel.addEventListener('change',()=>{document.dispatchEvent(new CustomEvent('ge-dashboard-period-change',{detail:{year:sel.value}}))});
}
