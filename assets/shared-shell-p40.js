/* P40-R9 canonical shared-shell bootstrap. */
(function(){
(function(){
'use strict';
const NAV_SVG={
...
function shell(){
 ...
 setupPeriodControl();
 window.__GE_CANONICAL_SHELL_RENDERED=true;
}
...
function boot(){try{shell()}catch(e){console.error('[P40-R9] canonical shell boot failed',e)}}
boot();
