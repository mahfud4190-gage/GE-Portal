...
const path=()=>window.GE_ROUTE||'index.html';
...
function ensureShell(){
 if(!finalUserPages.has(path())) return null;
...
function shell(){
 if(!finalUserPages.has(path()))return;
 ...
 <div class="ge-brand-logos"><img class="garuda" src="assets/brand/garuda-horizontal-white.png" alt="Garuda Indonesia"><img class="danantara" src="assets/brand/danantara-white-user.png" alt="Danantara Indonesia"></div>
...
function replaceBrand(){document.querySelectorAll('.ge-brand-logos .garuda').forEach(img=>img.src='assets/brand/garuda-horizontal-white.png')}
